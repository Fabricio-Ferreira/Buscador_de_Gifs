  ...
  Future<Map> _getGifs() async {
    ...
    if(_search == null || _search.isEmpty)
      response = await http.get("https://api.giphy.com/v1/gifs/trending?"
          "api_key=BUpQSFN9NecMke9qYKB1guCFvF9mug5A&limit=20&rating=G");
    else
      response = await http.get("https://api.giphy.com/v1/gifs/search?"
          "api_key=BUpQSFN9NecMke9qYKB1guCFvF9mug5A&q=$_search&limit=19&"
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Image.network("https://developers.giphy.com/static/img/"
              "dev-logo-lg.7404c00322a8.gif"),
          centerTitle: true,
        ),
        backgroundColor: Colors.black,
        body: Column(
